										...
										<div>
                                                                                    <form action="EditorialControl" method="post" class="form-horizontal"> 
                                                                                        <div class="form-group" >
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="direccion" value="" placeholder="ingrese direccion" />
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="telefono" value="" placeholder="numero" />
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="email" value="" placeholder="su correo:" />
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="sitioweb" value="" placeholder="ingrese el sitio" />
                                                                                            </div>
                                                                                        </div>
